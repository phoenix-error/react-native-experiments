...
// NOTE: the canvas painters (`paint`, `paintLines`, `paintFrame`) from the
// upstream engine are omitted in this vendored copy — this app renders the
// frame's dot/line lists with react-native-svg instead of a 2D canvas, so
// nothing here depends on `CanvasRenderingContext2D`.
